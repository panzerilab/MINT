classdef test_Solve_w_ECOSarrays < matlab.unittest.TestCase
    ...
    methods (Test)
        function testConstructor(testCase)
            ...
            myObject = Solve_w_ECOSarrays(marg_xy, marg_xz);
            testCase.verifyClass(myObject, 'Solve_w_ECOSarrays');
        end
        ...
        function calculate_entropy_X2(testCase)
            rng("default")
        ...
        function calculate_large_distribution(testCase)
            ...
            condent_orig = myObject.condentropy_orig2(p_xyz);
        ...
        function calculate_condentropy_orig2(testCase)
            rng("default")
            ...
            result = myObject.solve();
            myObject.addqdistr();
            condent_orig = myObject.condentropy_orig2(prob_xyz);
            assert(isequal(result, 'success'));
        ...
        function calculate_CI_copy_gate(testCase)    
            ...
            condent       = myObject.condentropy2();
            condent_orig = myObject.condentropy_orig2(p_xyz);
            condYmutinf   = myObject.condZmutinf2();
            condZmutinf   = myObject.condYmutinf2();
            bits = 1/log(2);
            si  = (entropy_X  - condent - condZmutinf - condYmutinf) * bits;
            uiy = condYmutinf* bits;
            uiz = condZmutinf* bits;
        ...
        function calculate_CI_xorand_gate(testCase)
            ...
            condZmutinf   = myObject.condZmutinf2();
            bits = 1/log(2);
            entropy_X     = entropy_X * bits;
            condent       = condent * bits;
            condent_orig  = condent_orig * bits;
            condYmutinf   = condYmutinf * bits;
            condZmutinf   = condZmutinf * bits;
